...
2. **No session yet:**
   - Suggested routers: `feature_dev`, `full_task_with_ingest`, or another router matching the task type (bugfix, refactor, …) — see **`.cursor/vibe-coding/devkit/routers/*.json`**.
